...
window.i18nData.zh = {
  ...
  ai: {
    ...
    qwenDesc: '文本生成 · GGUF · 32K上下文',
    qwen35Model: 'Qwen3.5-0.8B',
    qwen35Desc: '新一代 · GGUF · 262K上下文 · 视觉语言',
    importAsQwen35: '导入为 Qwen3.5 模型',
  ...
  toast: {
    // 设置
    settingsSaved: '设置已保存',
    dynamicConfigSaved: '动态设计 API 配置已保存',
    pleaseSetApiUrl: '请先设置 API 地址',
    pleaseEnterApiUrl: '请先填写 API 地址',
    fetchModelsFail: '获取模型列表失败',
    foundModels: '获取到 {n} 个模型',
    foundAvailModels: '发现 {n} 个可用模型',
    noModelsFound: '未找到可用模型',
    // 历史 & 收藏
    loadHistoryFail: '加载历史记录失败',
    loadFavoritesFail: '加载收藏失败',
    deleted: '已删除',
    deleteFail: '删除失败',
    historyCleaned: '已清空历史记录',
    clearFail: '清空失败',
    historyLoaded: '已加载历史记录',
    generateFirst: '请先生成提示词',
    favoriteSuccess: '收藏成功！',
    favoriteFail: '收藏失败',
    favoriteLoaded: '已加载收藏参数，可以修改后重新生成',
    // AI 图像生成
    aiCallFail: '⚠️ AI 调用失败: {msg}',
    noAiConfigNoLocal: '⚠️ 未配置 AI API 且未启用本地模型，无法生成专业图像提示词。请在设置中配置 API 或在离线模式中启用本地模型优先。',
    genFail: '生成失败',
    // 设计
    loadPresetsFail: '加载设计模板失败',
    loadPresetDetailFail: '加载模板详情失败',
    // 技能
    loadSkillsFail: '加载技能列表失败',
    rescanFail: '重新扫描失败',
    scanDone: '扫描完成，发现 {n} 个技能',
    loadSkillDetailFail: '加载技能详情失败',
    skillEnabled: '技能已启用',
    skillDisabled: '技能已禁用',
    toggleFail: '切换状态失败',
    fillIdAndName: '请填写 ID 和名称',
    skillCreated: '技能 "{name}" 创建成功！',
    skillCreateFail: '创建技能失败',
    skillDeleted: '技能已删除',
    skillDeleteFail: '删除技能失败',
    skillExported: '技能已导出',
    skillExportFail: '导出技能失败',
    skillImported: '技能 "{name}" 导入成功！',
    skillImportFail: '导入失败，请检查 JSON 格式',
    skillLoadFail: '加载技能失败',
    skillUpdated: '技能已更新',
    skillSaveFail: '保存失败',
    // 剪贴板
    ...
    copyFail: '复制失败',
    // 动态设计
    needBrandOrDesc: '请至少输入品牌名称或设计描述',
    needApiConfig: '请先配置 AI 服务（API 地址和模型）—— 可在全局设置或动态设计独立配置中设置',
    needApiConfigShort: '请先配置 AI 服务',
    dynamicGenSuccess: '🎬 动态设计生成成功！',
    dynamicGenFail: '生成失败: {msg}',
    codeApplied: '代码已应用到预览',
    previewRefreshed: '预览已刷新',
    iterateSuccess: '🔄 迭代修改成功！',
    iterateFail: '迭代失败: {msg}',
    htmlDownloaded: 'HTML 文件已下载',
    capturingFrames: '正在截取动画帧...',
    capturedFrames: '已截取 {n} 帧，正在编码 GIF...',
    gifDownloaded: 'GIF 动图已下载（{frames} 帧，{size}KB）',
    gifExportFail: 'GIF 导出失败: {msg}',
    gifLibMissing: 'gif.js 库未加载，GIF 导出不可用',
    capturedFramesVideo: '已截取 {n} 帧，正在编码视频...',
    videoDownloaded: '{format} 视频已下载（{frames} 帧，{size}KB）',
    videoExportFail: '视频导出失败: {msg}',
    videoNotSupported: '您的浏览器不支持视频录制功能',
    // AI 模型管理
    modelDownloadStart: '模型 {id} 开始下载...',
    modelDownloadDone: '模型 {id} 下载完成！',
    downloadFail: '下载失败: {msg}',
    modelLoading: '正在加载模型 {id}...',
    modelLoadSuccess: '模型 {id} 加载成功！',
    modelLoadFail: '加载失败: {msg}',
    modelUnloaded: '模型 {id} 已卸载',
    modelUnloadFail: '卸载失败: {msg}',
    modelDeleted: '模型 {id} 已删除',
    modelDeleteFail: '删除失败: {msg}',
    pleaseEnterTestText: '请输入测试文本',
    scanFoundModels: '发现 {n} 个模型文件，状态已更新',
    scanNoModels: '未发现新的模型文件。请将 .gguf 文件放入 models/ 目录后再试',
    scanFail: '扫描失败: {msg}',
    pleaseEnterModelPath: '请输入模型文件的完整路径',
    modelImportSuccess: '模型导入成功！({size})',
    modelImportFail: '导入失败: {msg}',
    // 安全审查
    safetyEnabled: '安全审查已启用',
    safetyDisabled: '安全审查已禁用',
    safetyConfigFail: '更新安全配置失败',
    safetyStatsReset: '安全统计已重置',
    resetFail: '重置失败',
    // 离线
    localModelPriorityOn: '已启用本地模型优先',
    localModelPriorityOff: '已切换回外部 API 优先',
    // AI 降级通知
    apiFallbackLocal: '⚠️ 外部 API 不可用，已自动切换到本地模型',
    aiRequestTimeout: 'AI请求超时（60秒），请检查网络或API服务状态',
    aiResponseEmpty: 'AI返回内容为空'
  },

  // === 确认对话框 ===
  confirm: {
    deleteRecord: '确定要删除这条记录吗？',
    clearAllHistory: '确定要清空所有历史记录吗？此操作不可恢复！',
    deleteFavorite: '确定要删除这个收藏吗？',
    deleteModel: '确定要删除模型 {id} 吗？删除后需要重新下载。',
    resetSafetyStats: '确定要重置安全审查统计吗？'
  },
